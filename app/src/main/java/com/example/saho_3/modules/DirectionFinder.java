...
public class DirectionFinder {
    ...
    private void parseJSon(String data) throws JSONException {
        ...
        for (int i = 0; i < jsonRoutes.length(); i++) {
            ...
            String end_address = jsonLeg.getString("end_address");
            String start_address = jsonLeg.getString("start_address");
            ...
            Route route = new Route(distance, duration, start_address, end_address, startLocation, endLocation, points);
            routes.add(route);
        }
